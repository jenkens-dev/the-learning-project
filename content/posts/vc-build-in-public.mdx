...
- **Do you have any blockers?**
    - I kind of want to read manga and watch K-dramas all day. I'm hoping to push through and work a bit, once I get started I know I can finish the 1 hour block I want to get done.
...
## Day 7 - 06/08
- **What did you do yesterday?**
   - Submitted and merged a PR for work and I' almost done with another one! 
   - Worked on side project and then decided I didn't like the technology I was using so I scrapped it and started working from a blank slate
- **What are you doing today?**
    - Finishing PR for UI bug at work
    - Restarting project with different technologies 
- **Do you have any blockers?**
    - Feels frustrating to pick a technology that wasn't right for me and having to start over. I felt like I was making decent progress but now I'm back to square one.  