...
- **What did you do yesterday?** 
	- Did some design research and some basic wireframing
    - Planned user stories and thought about potential stretch goals 
- **What are you doing today?**
    - Set up github 
- **Do you have any blockers?**
    - Starting projects is always a little difficult because there is so much to do at the beginning that it can feel pretty overwhelming but I hope to set up a board to help me stay on track and keep my focus.  

Day 2 - 06/22 
- **What did you do yesterday?** 
	- Set up [github repo](https://github.com/jenkens-dev/bullet-journal)
    - Got Node and TypeScript working together 
- **What are you doing today?**
    - I'll be working on defining my Models and creating MikroORM Entities
- **Do you have any blockers?**
    - Nope excited to start! 

Day 3 - 06/23
- **What did you do yesterday?** 
	- Set up MikroORM Entities, created an associated table, and ran some migrations!
    - Setting up backend models is always tricky for me so it's great that I was able to get some feedback and advice on my approach 
- **What are you doing today?**
    - Set up GraphQL and start making queries! 
- **Do you have any blockers?**
    - The weather is really nice and sometimes it feels hard to code after work
