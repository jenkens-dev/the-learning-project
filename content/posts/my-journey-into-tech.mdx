...
After learning a bit of Java, I switched to learning HTML, CSS, and JavaScript. I read a lot that web development or frontend development might be easier to learn. For me, it really helped to get feedback that I could see in the browser and I loved painting on a blank canvas. I used [Codecademy](https://www.codecademy.com/) and [FreeCodeCamp](https://www.freecodecamp.org/) to as my learning resources. I got my frontend development certificate from FreeCodeCamp in 2018 after learning on and off! 
...
Finally, I decided that the best thing for me to do was go to a boot camp. I needed the schedule and teachers to help keep me accountable because after trying to teach myself for so long I was too tired to keep motivating myself every day. After researching a bunch of different boot camps I decided to go to Flatiron and I'm really happy with the choice I made. Although I have a lot of complaints about how the boot camp was done overall it helped me end up where am I and I made a lot of lifelong friends. 

We learned Ruby, Rails, JavaScript, and React. It was great to learn a backend language since I didn't have any experience before and re-learning JavaScript and React really helped me solidify my fundamentals and clear up some confusing parts. Sometimes I have to learn things a couple of different times for them to really stick. I graduated in January and was really excited to start looking for a full-time job.
