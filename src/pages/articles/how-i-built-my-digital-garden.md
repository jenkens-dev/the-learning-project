...
Then in normal Gatsby style you can create a Layout component and SEO component. Layout components are used for repeating sections across different pages of your site, such as nav bars. SEO stands for 'Search Engine Optimization' and we can add this component to our Layout 


### Goals for the Future

- Continue writing more posts ✍️
- Add code highlighting to posts to make code blocks more noticable and easier to read
